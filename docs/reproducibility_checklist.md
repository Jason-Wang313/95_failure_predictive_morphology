...
- [x] `results/seed_morph_task_metrics.csv`
...
- [x] `figures/morphology_prediction_quality.png`
- [x] `figures/morphology_task_outcomes.png`
- [x] `figures/morphology_cost_regret.png`
- [x] `figures/morphology_ablation.png`
- [x] `figures/morphology_stress_sweep.png`
- [x] `paper/main.tex`
- [x] Canonical PDF target: `C:/Users/wangz/Downloads/95.pdf`
