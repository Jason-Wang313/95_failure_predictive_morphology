...
1. Chosen thesis: Failure-Predictive Morphology explores `Predict which morphology-specific constraints will dominate policy failure.` for robot morphology and learning.
...
8. Exact Downloads PDF path: `C:/Users/wangz/Downloads/95.pdf`
9. GitHub URL: https://github.com/Jason-Wang313/95_failure_predictive_morphology
