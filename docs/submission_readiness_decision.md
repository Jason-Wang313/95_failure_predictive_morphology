...
Honest strongest claim: `Predict which morphology-specific constraints will dominate policy failure.` is a plausible branch-structured mechanism for robot morphology and learning, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
