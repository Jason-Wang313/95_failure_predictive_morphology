...
This repository contains a hardened, honest workshop-only robotics paper draft for `failure_predictive_morphology`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/95.pdf`
